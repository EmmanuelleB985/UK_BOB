    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        if (epoch + 1) % args.val_every == 0:
            ...
            val_acc = val_epoch(
                ...
                model_inferer, post_label, post_pred
            )
...
def log_organ_metrics(
    organ_scores: np.ndarray,
    epoch: int,
    args: Any
) -> None:
    """
...
def log_configuration(writer: SummaryWriter, args: Any) -> None:
    ...
    important_args = [
        "batch_size", "max_epochs", "optim_name", "optim_lr",
        "feature_size", "roi_x", "roi_y", "roi_z",
        "in_channels", "out_channels", "distributed"
    ]
